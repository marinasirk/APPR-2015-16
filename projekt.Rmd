...
Slika \ref{fig:graf} prikazuje porazdelitev števila razvez v regijah.

```{r graf, echo=FALSE, fig.align='center', fig.cap='Graf števila razvez v regijah glede na trajanje zakonske zveze'}
